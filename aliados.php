...
<main>
		...
		<p><br></p>
			<section class="row">
				...
				<?php
					$afiliados_lista = json_decode( file_get_contents( DATA. "afiliados_links.json") );
					$new_afiliados = array();
		...
		<img src="./img/bg_afiliados_desk.svg" class="bg_desk" alt="">
		<img src="./img/bg_afiliados_movil.svg" class="bg_movil" alt="">
	</section>
</main>
